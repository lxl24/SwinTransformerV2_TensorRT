...
def run():
    ...
    inputTensorList = []
    inputTensorList.append( network.add_input('inputT', trt.float32, [-1,-1,384]) )
    inputTensorList.append( network.add_input('inputB', trt.float32, [384]) )
    inputTensorList.append( network.add_input('inputA', trt.float32, [384]) )

    profile = builder.create_optimization_profile()
    profile.set_shape('inputT',[1,4,384],[1024,64,384],[1024,128,384])
