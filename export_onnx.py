...
def parse_option():
    ...
    parser.add_argument('--resume', default='/home/lixianglong/SwinTransformerV2_TensorRT/swinv2_small_patch4_window8_256.pth', help='resume from checkpoint')
...
def export_onnx(model, config):
    ...
    try:
        ...
        torch.onnx.export(model, dummy_input, f, verbose=False, opset_version=11,
